                    ...
                    items.map((item,index)=>
                        ...
                        (
                            ...
                            >
                                ...
                                <span className={`${!sidebarExpanded && 'text-center'}`}>
                                    {item.label}
                                </span>
                            </NavLink>
                        )
